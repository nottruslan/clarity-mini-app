      ...
      try {
        ...
        html = html.replace(
          ...
          (match, src) => {
            ...
            return `<script type="module" src="${src}" onload="console.log('[DEBUG] Module loaded:', '${scriptName}');" onerror="console.error('[DEBUG] Module failed:', '${scriptName}', this.src);"></script>`;
          }
        );
