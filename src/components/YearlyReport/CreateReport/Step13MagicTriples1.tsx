...
interface Step13MagicTriples1Props {
  onNext: (triples: FutureYearData['magicTriples1']) => void;
  onBack: () => void;
  initialData?: FutureYearData['magicTriples1'];
}

export default function Step13MagicTriples1({ onNext, onBack, initialData }: Step13MagicTriples1Props) {
  ...
  return (
    <WizardSlide
      icon="✨"
      title="Волшебные тройки - часть 1"
