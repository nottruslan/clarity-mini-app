...
interface Step28MagicTriples2Props {
  onNext: (triples: FutureYearData['magicTriples2']) => void;
  onBack: () => void;
  initialData?: FutureYearData['magicTriples2'];
}

export default function Step28MagicTriples2({ onNext, onBack, initialData }: Step28MagicTriples2Props) {
