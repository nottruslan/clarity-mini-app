...
interface EditReflectionModalProps {
  ...
  onSave: (updates: Partial<Reflection>) => void;
  onClose: () => void;
}

export default function EditReflectionModal({ reflection, onSave, onClose }: EditReflectionModalProps) {
