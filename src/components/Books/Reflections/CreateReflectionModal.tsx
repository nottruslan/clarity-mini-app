...
interface CreateReflectionModalProps {
  bookId: string;
  onSave: (reflection: { id: string; bookId: string; title?: string; content: string; createdAt: number; updatedAt: number }) => void;
  onClose: () => void;
}

export default function CreateReflectionModal({ bookId, onSave, onClose }: CreateReflectionModalProps) {
        ...
        <div style={{ padding: '0 20px' }}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <input
              ...
              placeholder="Заголовок размышления"
              style={{
                width: '100%',
                padding: '12px',
